...
router.post("/add", verifyToken, async (req, res) => {
  try {
    ...
    // 2️⃣ Automatic Stock Increase in products table
    ...
    // 3️⃣ Add to inventory table for stock tracking
    ...
    await logActivity(
      ...
      'INWARD',
      result.rows[0].id,
      `Added inward: ${qty} units of product ID ${product_id}, GRN: ${grn}`,
      null
    );
